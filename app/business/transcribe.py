...
async def transcribe_audio(data: bytes, filename: str = "audio.wav", content_type: str = "audio/wav") -> str:
    ...
    # A short vocabulary hint biases Whisper toward shop-commerce words + KSh.
    hint = (
        "Duka / provision-shop commerce in Kenya. Money in Kenyan Shillings (KSh, bob). "
        "Languages: English, Swahili, Sheng. Keep quantities and amounts as digits."
    )
